...
// Common base wrapper
const IconWrapper = ({ children, size = 20, className = '', strokeWidth = 2, onClick }) => (
  <svg
...
export const Chevron = ({ direction = 'down', ...props }) => {
  const points = {
    down: '6 9 12 15 18 9',
    up: '18 15 12 9 6 15',
...
export const Rupee = (props) => (
  <IconWrapper {...props}>
    <path d="M6 3h12M6 8h12M6 3c5 0 7 2 7 5 0 3-2 5-7 5h1M13 13l6 8" />
  </IconWrapper>
);
